...
import `in`.nitin.newsapp.datasource.network.ApiConstant.CONNECT_TIME_OUT
import `in`.nitin.newsapp.datasource.network.ApiConstant.HEADER_CACHE_CONTROL
import `in`.nitin.newsapp.datasource.network.ApiConstant.HEADER_PRAGMA
import `in`.nitin.newsapp.datasource.network.ApiConstant.NETWORK_INTERCEPTOR_MAX_AGE
import `in`.nitin.newsapp.datasource.network.ApiConstant.READ_TIME_OUT
import `in`.nitin.newsapp.datasource.network.ApiConstant.WRITE_TIME_OUT
